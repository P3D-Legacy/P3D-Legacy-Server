...
namespace P3D.Legacy.Server.Abstractions.Notifications
{
    ...
    public interface INotificationDispatcher
    {
        ...
        Task DispatchAsync<TNotification>(TNotification notification, CancellationToken ct) where TNotification : INotification;
        Task DispatchAsync<TNotification>(TNotification notification, DispatchStrategy dispatchStrategy, CancellationToken ct) where TNotification : INotification;
    }
}