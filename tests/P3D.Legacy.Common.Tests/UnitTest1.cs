...
namespace P3D.Legacy.Common.Tests
{
    public class DataItemTests
    {
        private sealed record Container() : P3DPacket(P3DPacketType.NotUsed)
        {
            ...
            public bool IsCorrect { get => DataItemStorage.GetBool(1); set => DataItemStorage.SetBool(1, value); }
            public ulong IdLong { get => DataItemStorage.GetUInt64(2); set => DataItemStorage.SetUInt64(2, value); }
            public char Char { get => DataItemStorage.GetChar(3); set => DataItemStorage.SetChar(3, value); }
            public int IdInt { get => DataItemStorage.GetInt32(4); set => DataItemStorage.SetInt32(4, value); }
